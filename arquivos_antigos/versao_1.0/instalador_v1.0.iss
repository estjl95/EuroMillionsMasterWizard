...
DefaultDirName={pf}\EuroMillionsMasterWizard
DefaultGroupName=EuroMillionsMasterWizard
OutputDir={userdocs}\EuroMillions Master Wizard v1.0
OutputBaseFilename=Setup
SetupIconFile=icone.ico
Compression=lzma
SolidCompression=yes
LicenseFile=LICENSE.txt
UninstallDisplayName=EuroMillions Master Wizard
