...
DefaultDirName={pf}\EuroMillionsMasterWizard v1.5
DefaultGroupName=EuroMillions Master Wizard v1.5
OutputDir={Output}\EuroMillions Master Wizard v1.5
Uninstallable=yes
DisableDirPage=no
...
UninstallDisplayName=EuroMillions Master Wizard v1.5
WizardStyle=modern
