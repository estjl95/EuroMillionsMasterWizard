...
DefaultDirName={pf}\EuroMillionsMasterWizard v1.3
DefaultGroupName=EuroMillionsMasterWizard v1.3
OutputDir={userdocs}\EuroMillions Master Wizard v1.3
OutputBaseFilename=Setup
SetupIconFile=icone.ico
Compression=lzma
SolidCompression=yes
LicenseFile=LICENSE.txt
UninstallDisplayName=EuroMillions Master Wizard v1.3
...
Source: "dist\msgbox\msgbox.exe"; DestDir: "{app}"; Flags: ignoreversion
